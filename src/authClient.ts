...
const openInstance = require('open');
...
module.exports = ({ oktaOrgUrl, clientId, scopes, serverPort }: { oktaOrgUrl: String, clientId: String, scopes: any, serverPort: any}) => {
  ...
  const buildAuthorizeUrl = (codeChallenge: any) => {
    const data = {
      client_id: clientId,
      response_type: 'code',
      scope: scopes,
